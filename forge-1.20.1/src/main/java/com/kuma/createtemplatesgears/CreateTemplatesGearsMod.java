...
@Mod("create_templates_gears")
public class CreateTemplatesGearsMod {
	public static final Logger LOGGER = LogManager.getLogger(CreateTemplatesGearsMod.class);
	public static final String MODID = "create_templates_gears";

	public CreateTemplatesGearsMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		CreateTemplatesGearsModItems.REGISTRY.register(bus);

		CreateTemplatesGearsModTabs.REGISTRY.register(bus);
